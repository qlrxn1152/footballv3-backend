...
public class TeamJoinRequestController {
    ...
    @DeleteMapping("/api/teams/{teamId}/join-requests/me")
    public ResponseEntity<Void> cancelJoinRequest(@AuthenticationPrincipal Jwt jwt, @PathVariable Long teamId) {
        teamJoinRequestService.cancelJoinRequest(teamId, Long.valueOf(jwt.getSubject()));
